...
abstract contract StakingHbbftBase is UpgradeableOwned, IStakingHbbft {
    // =============================================== Storage ========================================================
    ...
    function _sendWithdrawnStakeAmount(address payable _to, uint256 _amount) internal virtual;
